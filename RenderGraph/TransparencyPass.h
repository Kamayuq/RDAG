...
namespace RDAG
{
	...
	struct TransparencyInput : Texture2dResourceHandle
	{
	...
	struct TransparencyResult : Texture2dResourceHandle
	{
	...
	struct HalfResTransparencyResult : Texture2dResourceHandle
	{
